...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="LabelNumber4" runat="server" Text="4" Width="30" Height="30" style="text-align: center"></asp:Label>
    
    <asp:Label ID="LabelVertical1" runat="server" Text="  " Width="30" Height="30" style="text-align: center"></asp:Label>
    
    <asp:Label ID="LabelNumber5" runat="server" Text="5" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber6" runat="server" Text="6" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber7" runat="server" Text="7" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber8" runat="server" Text="8" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber9" runat="server" Text="9" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber10" runat="server" Text="10" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber11" runat="server" Text="11" Width="30" Height="30" style="text-align: center"></asp:Label>
    
    <asp:Label ID="LabelVertical2" runat="server" Text="  " Width="30" Height="30" style="text-align: center"></asp:Label>

    <asp:Label ID="LabelNumber12" runat="server" Text="12" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber13" runat="server" Text="13" Width="30" Height="30" style="text-align: center"></asp:Label>           
    <asp:Label ID="LabelNumber14" runat="server" Text="14" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber15" runat="server" Text="15" Width="30" Height="30" style="text-align: center"></asp:Label>
    <asp:Label ID="LabelNumber16" runat="server" Text="16" Width="30" Height="30" style="text-align: center"></asp:Label>
    ...
    <!--　　-->
    <asp:Image ID="ImageRoad1" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad2" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad3" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRpad4" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad5" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="Imageroad6" runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad7"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad8"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad9"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad10"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad11"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad12"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad13"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad14"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad15"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad16"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad17"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad18"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad19"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad20"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad21"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad22"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad23"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad24"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad25"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad26"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad27"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad28"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad29"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad30"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad31"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad32"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad33"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    <asp:Image ID="ImageRoad34"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>    
    ...
    <asp:Image ID="ImageRoad35"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad36"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad37"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad38"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad39"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad40"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad41"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
    ...
    <asp:Image ID="ImageRoad42"	runat="server" ImageUrl="/img/tuuro.png" Width="30" Height="30"/>
