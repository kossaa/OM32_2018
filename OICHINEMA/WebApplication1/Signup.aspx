<%@ Page Title="" Language="C#" MasterPageFile="~/OICHINEMA.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="WebApplication1.Signup" MaintainScrollPositionOnPostback="true"%>
...
--------------------------------------------------------------------------------------------*/
    ...
    <asp:Panel ID="Panel7" CssClass="BirthPanel" runat="server">
        ...
        <asp:Label ID="Label7" runat="server" Text="（西暦）" ></asp:Label>
    ...
    <asp:Panel ID="Panel2" CssClass="AddressPanel" runat="server">
        ...
        <asp:Label ID="Label18" runat="server" Text="パスワード"></asp:Label>
            <br />
        <asp:TextBox ID="PassTxb" CssClass="TextBox" runat="server" TabIndex="13">Qwert12345</asp:TextBox>
        <br />
