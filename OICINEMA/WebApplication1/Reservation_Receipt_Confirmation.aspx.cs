...
namespace WebApplication1
{
    public partial class Reservation_Receipt_Confirmation : System.Web.UI.Page
    {
        ...
        {
            if ((string)Session["PageID"] != "Reservation_Confirm_Input_Information_Next" && !IsPostBack)
            {
                //各Sessionのクリア
            ...
            BookingIDLabel.Text = "購入番号：" + Session["BookingBuy"].ToString();
