...
{
    public partial class Screen01 : System.Web.UI.Page
    {
        ...
        protected void ImageBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //Nullじゃないとき＝2席目から
            if (Session["SeatInformation"] != null)
            {
                seatList = (List<string>)Session["SeatInformation"];
            }
            //クリックされたら色を変える
            ...
            //クリックされているSession["SeatInformation"]
        ...
        {
            //クリックされているseatListにSession["SeatInformation"]を入れる
            seatList = (List<string>)Session["SeatInformation"];
            //空要素(null)を一括削除
