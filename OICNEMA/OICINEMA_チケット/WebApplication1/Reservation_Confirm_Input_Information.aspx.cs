    ...
    public partial class test : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((string)Session["MemberID"] != "")//ログインされていたら会員番号から会員名を取り出して表示する
            {
                ...
                OleDbDataAdapter daRate = new OleDbDataAdapter("SELECT MEMBER_NAME FROM TBL_MEMBER WHERE MEMBER_ID='" + (string)Session["MemberID"] + "'", cn);
        ...
        protected void AcceptBtn_Click(object sender, EventArgs e)
        {
            ...
            //予約テーブルに予約情報と売上を追加する
            //BOOKING_ID = MAX(BOOKING_ID) + 1
            //OleDbDataAdapter daBooking = new OleDbDataAdapter("INSERT INTO TBL_BOOKING VALUES ('CONVERT(int, '1234')BOOKING_ID = MAX(BOOKING_ID) + 1')", cn);
