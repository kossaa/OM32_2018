        ...
        <table border="0">
            <tr>
               <td class="auto-style1">
                   <table border="1">
                        <tr>
                            <td class="auto-style1" bgcolor="#8fbc8f">テーブル1</td>
                            <td class="auto-style2" bgcolor="#8fbc8f">テーブル2</td>
                            <td class="auto-style3" bgcolor="#ffff00">テーブル3</td>
                        </tr>
                            <tr>
                            <td class="auto-style4" bgcolor="#8fbc8f">テーブル1</td>
                            <td class="auto-style5" bgcolor="#8fbc8f">テーブル2</td>
                            <td class="auto-style6" bgcolor="#ffff00">テーブル3</td>
                        </tr>
                            <tr>
                            <td class="auto-style7" bgcolor="#ff0000">テーブル1</td>
                            <td class="auto-style8" bgcolor="#ffff00">テーブル2</td>
                            <td class="auto-style9" bgcolor="#ffff00">テーブル3</td>
                        </tr>
                    </table>
                </td>
            </tr>
